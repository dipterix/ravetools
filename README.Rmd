...
The `multitaper` function uses the script derived from `Prerau's lab`. The `TinyParallel` script is derived from `RcppParallel` package with `TBB` features removed (only use `tinythreads`).
